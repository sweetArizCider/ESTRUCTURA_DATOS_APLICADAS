...
var Arreglo = /** @class */ (function () {
    ...
    Arreglo.prototype.obtenerParametrosHabitacion = function (accion) {
        return __awaiter(this, void 0, void 0, function () {
            var pais, estado, ciudad, torre, piso, habitacion;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("\n--- ".concat(accion, " ---"));
                    ...
                    case 6:
                        ...
                        return [2 /*return*/, [parseInt(pais), parseInt(estado), parseInt(ciudad), parseInt(torre), parseInt(piso), parseInt(habitacion)]];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, [parseInt(pais), parseInt(estado), parseInt(ciudad)]];
                }
            });
        });
    };
